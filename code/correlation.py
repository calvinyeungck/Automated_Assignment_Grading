...
pearson1 = stats.pearsonr(df_q1_aag, df_q1_ta)
print("Pearson correlation test in Q1: ", pearson1)
pearson2 = stats.pearsonr(df_q2_aag, df_q2_ta)
print("Pearson correlation test in Q2: ", pearson2)
